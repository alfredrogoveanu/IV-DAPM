...
const PWAActionSheet = class {
    ...
    render() {
        return (Object(_core_8e8be6a7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: `wrapper${this.open ? ' open' : ''}`, onClick: () => this.dismiss() }, Object(_core_8e8be6a7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "content" }, Object(_core_8e8be6a7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "title" }, this.header), this.options.map((option, i) => Object(_core_8e8be6a7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "action-sheet-option", onClick: (e) => this.handleOptionClick(e, i) }, Object(_core_8e8be6a7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "action-sheet-button" }, option.title))))));
    }
